public class QuadrantChartProperties
{
  ...
  function QuadrantChartProperties(metaData, parameterUtilities, log) {
    ...
    xAxisCrossingPoint = parameterUtilities.GetParameterDecimal(PositioningParameters.XAxisCrossingPoint, xAxisCrossingPoint);
    var yAxisCrossingPoint = (yAxisMaxAndMin.Max + yAxisMaxAndMin.Min)/2;
    yAxisCrossingPoint = parameterUtilities.GetParameterDecimal(PositioningParameters.YAxisCrossingPoint, yAxisCrossingPoint);
